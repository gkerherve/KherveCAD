...
SHAPES = {
    "mid": dict(nose=0.33, cowl=0.58, deck=0.70, tail=0.68,
                ws=0.28, rf=0.43, rr=0.55, cb=0.78,
                nose_w=0.64, tail_w=0.90, cabin=0.74, tumble=0.76,
                fo=0.46, fenders=True, crisp=0.8, belt=0.34),
    "wedge": dict(nose=0.27, cowl=0.55, deck=0.72, tail=0.74,
                  ws=0.25, rf=0.42, rr=0.55, cb=0.74,
                  nose_w=0.70, tail_w=0.96, cabin=0.72, tumble=0.78,
                  fo=0.45, fenders=False, crisp=0.95, belt=0.42),
    "front": dict(nose=0.39, cowl=0.62, deck=0.68, tail=0.66,
                  ws=0.44, rf=0.57, rr=0.70, cb=0.85,
                  nose_w=0.70, tail_w=0.90, cabin=0.78, tumble=0.80,
                  fo=0.42, fenders=True, crisp=0.5, belt=0.26),
    "longnose": dict(nose=0.39, cowl=0.68, deck=0.66, tail=0.58,
                     ws=0.48, rf=0.59, rr=0.72, cb=0.88,
                     nose_w=0.60, tail_w=0.82, cabin=0.80, tumble=0.80,
                     fo=0.48, fenders=True, crisp=0.3, belt=0.22),
    "rear": dict(nose=0.35, cowl=0.60, deck=0.60, tail=0.56,
                 ws=0.29, rf=0.42, rr=0.58, cb=0.95,
                 nose_w=0.66, tail_w=0.86, cabin=0.76, tumble=0.78,
                 fo=0.44, fenders=True, crisp=0.45, belt=0.26),
    "sedan": dict(nose=0.45, cowl=0.66, deck=0.72, tail=0.72,
                  ws=0.30, rf=0.43, rr=0.72, cb=0.82,
                  nose_w=0.80, tail_w=0.95, cabin=0.86, tumble=0.86,
                  fo=0.40, fenders=False, crisp=0.6, belt=0.24),
}
