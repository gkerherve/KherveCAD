...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "complete park), Sport ('Sport: stadiums' — whole grounds "
            "for football, rugby, athletics, tennis and indoor sports in "
            "six shapes: rounded bowl one or two tiers, oval, circular, "
            "horseshoe, four straight stands, indoor arena; with roof, "
            "changing rooms, tunnel, dugouts, scoreboards — plus "
            "'Sport: pitches & courts' (rugby, badminton, volleyball, "
            "handball, 400 m track, tennis show court), 'Sport: "
            "equipment' and 'Sport: seating' incl. the players' bucket "
            "seat and dugout), Lighting & signals (street lamps, traffic "
        ...
        "input_schema": _obj({
            ...
            "terrain": {"type": "object",
                        "description": "Build the city ON a landscape: "
                                       ...
                                       "(relief, mm), seed, roughness (0 "
                                       "smooth swells .. 0.5 default .. 1 "
                                       "tight bumpy ground), cells}. Roads "
