...
from . import (library_cards, library_chem, library_crystal,  # noqa: E402
               ...
               library_lego_sets,
               library_molecule, library_carbon, library_surfaces,
               ...
               library_characters, library_animals)
...
PARTS.update(library_surfaces.PARTS)
...
class PartLibraryDialog(QDialog):
    ...
    def __init__(self, model: DocumentModel, parent=None):
        ...
        for spec in PARTS.values():
            ...
            if cat not in cats:
                cats.append(cat)
        from .library_groups import category_order
        cats = category_order(cats)             # the Library menu's order
